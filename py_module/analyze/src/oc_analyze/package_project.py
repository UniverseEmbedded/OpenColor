...
def create_project_archive(
    ...
    for root, dirs, files in os.walk(project_root):
        ...
        for d in dirs:
            ...
            if should_exclude(dir_path, exclude_dirs, exclude_patterns, project_root, exclude_files):
        ...
        for file_name in files:
            ...
            # 检查是否应该排除
            if should_exclude(file_path, exclude_dirs, exclude_patterns, project_root, exclude_files):
                stats["excluded_files"] += 1
