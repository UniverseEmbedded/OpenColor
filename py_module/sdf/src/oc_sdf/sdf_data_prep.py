...
from oc_core_02.core.bitmap_pipeline import BitmapParams, _mask_transparency_and_bg, _flatten_lut, match_pixels_to_lut, \
    _precompute_base_m_digits
from oc_core_02.core.color_systems import ColorSystem
from .sdf_types import SDFParams


def prepare_data(pil: Image.Image, params: BitmapParams, sdf_params: SDFParams, lut_path: str) -> Dict:
    """准备匹配后的像素数据和预览
